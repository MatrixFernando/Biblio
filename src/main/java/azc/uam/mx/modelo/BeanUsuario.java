...
/*--->*/private String nombres="";  
	...
	@Pattern(regexp="[^0-9]*", message = "No es un apellido validos")
	@Size(min = 2, max = 50, message = "El apellido debe tener minimo de 2 a maximo 50 Caracteres")
    @NotEmpty(message = "No puede estar vacío")
...
/*--->*/private String confirmarcontrasenia="";   
	...
	public BeanUsuario(Long matricula, String nombres, String apellido_paterno, String apellido_materno, Integer edad, String correo, String contrasenia) {
	...
	public String toString (){
		String mensaje="Los argumentos son " +matricula+ " "+nombres+" "+apellido_paterno+" "+apellido_materno+" " +edad+ " "+correo+" "+contrasenia;
		return mensaje;
	}
